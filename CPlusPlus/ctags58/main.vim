...
map ,te :call Tabe_edit()
map ,ff :call Search_Word():copen
nmap <silent> ,fe :Vexplore
...
nmap <SNR>29_WE <Plug>AlignMapsWrapperEnd
map <SNR>29_WS <Plug>AlignMapsWrapperStart
nnoremap <silent> <Plug>NetrwBrowseX :call netrw#NetrwBrowseX(expand("<cWORD>"),0)
map <silent> <F7> :call RunX()
map <silent> <F5> :call ComplieX()
...
set sessionoptions=options,tabpages,winsize,winpos,sesdir,slash,unix
set shiftwidth=4
set smartcase
set smartindent
set softtabstop=4
...
set shortmess=aoO
badd +0 ~/CPlusPlus/ctags58/main.c
silent! argdel *
winpos 175 91
edit ~/CPlusPlus/ctags58/[File\ List]
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 100 - ((0 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
100
